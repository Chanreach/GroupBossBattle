...
const BossTemplate = () => {
  ...
  const handleAssignSelected = async () => {
    ...
    try {
      ...
      toast.success(
        `Successfully assigned ${selectedBosses.length} boss(es) to the event`
      );
      navigate(`/host/events/assign_boss?eventId=${eventId}`);
    } catch (error) {
      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 max-w-6xl">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Loading available bosses...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              {user?.role === "host" ? "(Your Bosses Only)" : ""}
            </div>
          </div>
