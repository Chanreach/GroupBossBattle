...
const Leaderboard = () => {
  ...
  const getRowBackground = (rank) => {
    if (rank === 1)
      return "bg-yellow-500 dark:bg-yellow-700 hover:bg-yellow-500 dark:hover:bg-yellow-600";
    if (rank === 2)
      return "bg-gray-400 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500";
    if (rank === 3)
      return "bg-amber-600 dark:bg-amber-800 hover:bg-amber-600 dark:hover:bg-amber-700";
    return "";
  };
  ...
  const paginatedIndividual = individualLeaderboard.slice(
