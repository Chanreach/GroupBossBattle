// ===== LIBRARIES ===== //
import { Users, Github, Linkedin, Mail, Heart } from "lucide-react";
      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 md:px-12 lg:px-20 xl:px-32 2xl:px-48 w-full">
          <div className="max-w-6xl mx-auto text-center w-full">
            {/* Main Hero Content */}
            <div
              className={`mb-12 sm:mb-16 transition-all duration-1000 ease-out delay-300 ${
                isVisible("hero")
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
            >
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-500 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed px-2">
                Each team member contributed their unique skills to create this
                comprehensive boss battle platform that combines modern frontend
                technologies, robust backend architecture, and intuitive user
                experience design.
              </p>
            </div>
            ...
            {/* CTA Buttons */}
            <div
              className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-12 sm:mb-16 px-2 transition-all duration-1000 ease-out delay-500 ${
                isVisible("hero")
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
            ...
            {/* Project Stats */}
            <div
              className={`grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-2xl mx-auto px-2 transition-all duration-1000 ease-out delay-700 ${
                isVisible("hero")
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-8"
              }`}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed px-4">
              The talented individuals who brought UniRAID to life through their
          ...
          {/* Technologies */}
          <div
            className={`grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16 transition-all duration-1000 ease-out delay-400 ${
              isVisible("team")
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
          >
            <Card className="text-center p-6 hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Built with React.js, styled with Tailwind CSS, and enhanced
                  with shadcn/ui components for a modern, responsive interface.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Powered by Node.js runtime with Express.js framework for
                  robust server-side logic, RESTful APIs, and real-time socket
                  connections.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow duration-300">
              <CardHeader>
                ...
                <CardDescription>
                  Designed with LucidChart and Draw.io for wireframing and
                  system architecture, creating intuitive user experiences and
                  visual workflows.
                </CardDescription>
              </CardHeader>
            </Card>
          ...
          {/* Team Members */}
          <div
            className={`flex flex-col items-center gap-6 transition-all duration-1000 ease-out delay-600 ${
              isVisible("team")
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-8"
            }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 justify-center">
              ...
              <Card className="flex flex-col text-center p-5 hover:shadow-lg transition-shadow duration-300 w-[300px] mx-auto">
                <div className="py-4 border-2 border-dashed rounded-sm">
                  ...
                  <div className="flex justify-center gap-3 mt-3">
                    ...
                    <a
                      href="https://www.linkedin.com/in/Chansovisoth"
                      className="text-gray-600 hover:text-blue-600 transition-colors"
                    >
                      <Linkedin className="w-4 h-4" />
                    </a>
                    <a
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=cwattanak%40paragoniu.edu.kh&authuser=0"
                      target="_blank"
              ...
              <Card className="flex flex-col text-center p-5 hover:shadow-lg transition-shadow duration-300 w-[300px] mx-auto">
                <div className="py-4 border-2 border-dashed rounded-sm">
                  ...
                  <div className="flex justify-center gap-3 mt-3">
                    <a
                      href="https://github.com/Chanreach"
                      className="text-gray-600 hover:text-green-600 transition-colors"
                    >
                      <Github className="w-4 h-4" />
                    </a>
                    <a
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=ctry1%40paragoniu.edu.kh&authuser=0"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 hover:text-green-600 transition-colors"
                    >
              ...
              <Card className="flex flex-col text-center p-5 hover:shadow-lg transition-shadow duration-300 w-[300px] mx-auto">
                <div className="py-4 border-2 border-dashed rounded-sm">
                  ...
                  <div className="flex justify-center gap-3 mt-3">
                    <a
                      href="https://github.com/Rithy404"
                      className="text-gray-600 hover:text-purple-600 transition-colors"
                    >
                      <Github className="w-4 h-4" />
                    </a>
                    <a
                      href="https://www.linkedin.com/in/rithy-chan-67314033b/"
                      className="text-gray-600 hover:text-purple-600 transition-colors"
                    >
                      <Linkedin className="w-4 h-4" />
                    </a>
                    <a
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=rchan2%40paragoniu.edu.kh&authuser=0"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 hover:text-purple-600 transition-colors"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 justify-center">
              ...
              <Card className="flex flex-col text-center p-5 hover:shadow-lg transition-shadow duration-300 w-[300px] mx-auto">
                <div className="py-4 border-2 border-dashed rounded-sm">
                  ...
                  <div className="flex justify-center gap-3 mt-3">
                    <a
                      href="https://github.com/sodavith"
                      className="text-gray-600 hover:text-orange-600 transition-colors"
                    >
                      <Github className="w-4 h-4" />
                    </a>
                    <a
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=snuon%40paragoniu.edu.kh&authuser=0"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 hover:text-orange-600 transition-colors"
                    >
              ...
              <Card className="flex flex-col text-center p-5 hover:shadow-lg transition-shadow duration-300 w-[300px] mx-auto">
                <div className="py-4 border-2 border-dashed rounded-sm">
                  ...
                  <div className="flex justify-center gap-3 mt-3">
                    <a
                      href="https://github.com/sovitep"
                      className="text-gray-600 hover:text-red-600 transition-colors"
                    >
                      <Github className="w-4 h-4" />
                    </a>
                    <a
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=schea8%40paragoniu.edu.kh&authuser=0"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 hover:text-red-600 transition-colors"
                    >
